...
class P14_Spec extends FlatSpec {
  ...
  it should "calculate the correct result for statring number=5847" in {
    assert(3711 === P14_LongestCollatzSequence.calculate(5847))
  }

  it should "calculate the correct result for statring number=46500" in {
    assert(35655 === P14_LongestCollatzSequence.calculate(46500))
  }

  it should "calculate the correct result for statring number=54512" in {
    assert(52527 === P14_LongestCollatzSequence.calculate(54512))
  }

  it should "calculate the correct result for statring number=1000000" in {
